  ...
  try {
    ...
    const exercises = [
      // PEITO
      {
        ...
        description: "Deitar no banco, pegar a barra com pegada média, descer controlado até o peito e empurrar de volta.",
      },
      {
        ...
        description: "Banco inclinado a 30-45°, halteres na linha dos ombros, empurrar para cima unindo no topo.",
      },
      {
        name: "Crucifixo Reto",
        muscle_group: "Peito",
        ...
        description: "Deitado no banco, abrir os braços em arco com cotovelos levemente flexionados.",
      },
      {
        ...
        description: "Puxar as polias de cima para baixo cruzando na frente do corpo, contraindo o peitoral.",
      },
      ...
      // COSTAS
      {
        ...
        description: "Segurar a barra com pegada pronada, puxar o corpo até o queixo passar a barra.",
      },
      {
        ...
        description: "Inclinado a 45°, puxar a barra em direção ao abdômen, contraindo as escápulas.",
      },
      {
        name: "Pulley Frente",
        muscle_group: "Costas",
        ...
        description: "Puxar a barra até a altura do peito, focando na contração dos dorsais.",
      },
      {
        ...
        description: "Apoiado no banco, puxar halter em direção ao quadril, rotando o tronco minimamente.",
      },
      {
        ...
        description: "Levantar a barra do chão mantendo costas retas, quadril para trás, até extensão completa.",
      },
      ...
      // PERNAS
      {
        ...
        tags: ["composto", "força", "completo"],
        description: "Barra nas costas, descer até coxas paralelas ao chão, mantendo costas retas.",
      },
      {
        name: "Leg Press 45°",
        muscle_group: "Pernas",
        ...
        description: "Empurrar a plataforma com os pés na largura dos ombros, descer controlado.",
      },
      {
        ...
        description: "Sentado, estender as pernas até extensão completa, contraindo quadríceps.",
      },
      {
        name: "Mesa Flexora",
        muscle_group: "Pernas",
        ...
        description: "Deitado de bruços, flexionar pernas trazendo calcanhares em direção aos glúteos.",
      },
      {
        name: "Stiff",
        muscle_group: "Pernas",
        ...
        description: "Pernas quase estendidas, descer o peso mantendo coluna reta, sentindo alongamento posterior.",
      },
      ...
      // OMBROS
      {
        ...
        description: "Empurrar barra acima da cabeça até extensão completa dos braços.",
      },
      {
        ...
        description: "Elevar halteres lateralmente até altura dos ombros, cotovelos levemente flexionados.",
      },
      {
      ...
      },
      {
        ...
        description: "Inclinado à frente, abrir halteres lateralmente focando na parte posterior dos ombros.",
      },
      ...
      // BRAÇOS - BÍCEPS
      {
        ...
        description: "Flexionar cotovelos trazendo barra em direção aos ombros, sem balançar o corpo.",
      },
      {
        ...
        description: "Alternar flexão de cada braço, girando levemente o punho no topo.",
      },
      {
        name: "Rosca Martelo",
        muscle_group: "Bíceps",
        ...
        description: "Flexionar com pegada neutra (palmas voltadas para o corpo).",
      },
      {
        name: "Rosca Scott",
        muscle_group: "Bíceps",
        ...
        description: "Braços apoiados no banco, flexionar sem tirar cotovelos do apoio.",
      },
      ...
      // BRAÇOS - TRÍCEPS
      {
        ...
        description: "Deitado, descer barra em direção à testa, estender braços.",
      },
      {
        ...
        tags: ["isolamento", "definição", "contração"],
        description: "Puxar corda para baixo abrindo as pontas no final do movimento.",
      },
      {
        ...
        description: "Descer o corpo flexionando cotovelos, empurrar de volta até extensão completa.",
      },
      {
        name: "Tríceps Coice",
        muscle_group: "Tríceps",
        ...
        description: "Inclinado, estender o braço para trás contraindo o tríceps.",
      },
      ...
      },
      {
        ...
        description: "Alternar cotovelo com joelho oposto em movimento de pedalada.",
      },
      {
        ...
        description: "Elevar pernas mantendo-as estendidas ou semi-flexionadas.",
      },
      ...
      // GLÚTEOS
      {
        ...
        description: "Apoiar costas no banco, empurrar quadril para cima com barra sobre a pélvis.",
      },
      {
      ...
      },
      {
        ...
        description: "Dar passo à frente, descer até joelho de trás quase tocar o chão.",
      },
