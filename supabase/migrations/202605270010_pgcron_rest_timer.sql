-- Habilita pg_cron e registra o job de polling do rest timer (a cada minuto).
...
begin
  ...
  -- Registra: chama /api/internal/rest-timer/poll a cada minuto
  ...
  raise notice 'Cron job repzfit-rest-timer-poll registrado com sucesso (polling a cada minuto).';
end;
$job$;
